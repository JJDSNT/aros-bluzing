...
bt_status_t bt_sdp_parse_element(struct bt_buf_reader *r, struct bt_sdp_element *out)
{
    ...
    case SDP_TYPE_UINT:
    {
        ...
        case 2:
            ...
            break;
        default:
            return BT_ERR_INVALID_ARGUMENT; /* 8/16-byte ints not modeled */
        }
    ...
    case SDP_TYPE_UUID:
        ...
        return BT_ERR_INVALID_ARGUMENT; /* 32-bit UUID (size_desc 2) not modeled */
    ...
    default:
        return BT_ERR_INVALID_ARGUMENT; /* SInt/Text/Bool/Alt/URL not modeled */
    }
}
