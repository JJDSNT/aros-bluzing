#ifndef BLUETOOTH_L2CAP_CHANNEL_H
#define BLUETOOTH_L2CAP_CHANNEL_H
 ...
 *     bluetooth/l2cap.h's own scope reduction). The full spec allows
...
#endif /* BLUETOOTH_L2CAP_CHANNEL_H */
